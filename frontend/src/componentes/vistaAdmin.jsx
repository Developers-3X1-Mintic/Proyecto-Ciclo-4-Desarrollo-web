...
function VistaAdmin() {
  ...
  /*function cambiarCuerpoVentas() {
    ...
    setCuerpo(cuerpo = <ListaVentas></ListaVentas> );
              ...
              <div className="container-fluid justify-content-between">
                ...
                <div className="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                  <div className="navbar-nav">
                    <Link to="/" className="nav-link boton-menu">Lista de Productos</Link>
                    <Link to="/admin/modificar_productos" className="nav-link boton-menu">Modificar Producto</Link>
                    <Link to="/admin/agregar_productos" className="nav-link boton-menu">Agregar Producto</Link>
                    <Link to="/admin/ventas" className="nav-link boton-menu">Ventas</Link>
        ...
        <section className="w-100">
          <div className="container">
            <div className="row p-5">
              <Routes>
                <Route path="/" element={<ListaProductoAdmin />} />
                <Route path="/admin/modificar_productos" element={<ModificarProducto />} />
                <Route path="/admin/agregar_productos" element={<ModificarProducto />} />
                <Route path="/admin/ventas" element={<ListaVentas />} />
              </Routes>
            </div>
          </div>
        </section>
